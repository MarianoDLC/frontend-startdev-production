...
const NewExercise = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Cerrar modal después de 1.5 segundos y limpiar form
      setTimeout(() => {
  ...
  return (
    <>
      {/* Modal con fondo transparente para ver el contenido de atrás */}
          ...
          <div className="sticky top-0 bg-gradient-to-r from-purple-600 to-violet-600 p-6 flex items-center justify-between z-10 rounded-t-2xl">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-purple-100 text-sm">Crea un ejercicio de programación</p>
              </div>
            </div>
            <button
              onClick={onClose}
